...
3. Compile and upload the code at a flash frequency of 80 MHz and upload speed of 256000 for best effect.
4. Connect the wires of the ESP32 to the selected hardware apparatus and the SCAMP before running
